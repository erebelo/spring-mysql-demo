...
import com.erebelo.springmysqldemo.domain.response.broker.AddressResponse;
import com.erebelo.springmysqldemo.domain.response.broker.AdvisorLazyResponse;
...
import com.erebelo.springmysqldemo.domain.response.broker.BrokerTypeLazyResponse;
...
public interface BrokerMapper {
    ...
    default List<BrokerRelationshipResponse> mapSetBrokerAdvisorsToListRelationships(Set<BrokerAdvisorEntity> brokerAdvisors) {
